...
from project_utils.path import data_path, model_path

from motion import Generator
from motion import model_classification
...
if __name__ == '__main__':
    # Load model
    model = model_classification(channels=3, window_size=64, output_channels=1, fcn=True)
    # model = model_3D_conv()
    ...
    # Train model
    train_model(model, generator, epochs=500, save_path=model_path('detect_roi/model_fcn_noise.h5'))
